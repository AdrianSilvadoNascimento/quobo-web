...
import { ArrowLeft, Calendar, User, Smartphone, QrCode, AlertCircle, CheckCircle2, Clock, XCircle } from 'lucide-react';
        ...
        <div>
          ...
          <div className="flex items-center gap-4 text-sm text-slate-500 mt-1">
            ...
            <span className="flex items-center gap-1">
              ...
              Criado por {audit.responsible_id}
            </span>
          </div>
        </div>
      </div>
